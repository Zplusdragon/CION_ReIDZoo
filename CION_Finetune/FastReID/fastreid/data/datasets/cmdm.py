...
class CMDM(ImageDataset):
    ...
    def __init__(self, root='datasets', data_name='duke', split_mode='ori', 
        ...
        if data_name == "msmt17" or data_name=="msmt":
        ...
        if data_name == "msmt17" or data_name == "msmt":
            train = self.process_msmt17_dir(self.train_dir, self.list_train_path)
            query = self.process_msmt17_dir(self.query_dir, self.list_query_path, is_train=False)
            gallery = self.process_msmt17_dir(self.gallery_dir, self.list_gallery_path, is_train=False)
        else:
    ...
    def process_msmt17_dir(self, dir_path, list_path, is_train=True):
