...
def vit_tiny(img_size=(256, 128), stride_size=16, drop_path_rate=0.1, **kwargs):
    model = TransReID(
        img_size=img_size, patch_size=16, stride_size=stride_size, embed_dim=192, depth=12, num_heads=3,
