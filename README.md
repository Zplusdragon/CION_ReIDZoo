...
## News
* 🙂[2024.9.30] Our paper is released on [Arxiv](https://arxiv.org/abs/2409.18569).
...
The supervised fine-tuning performance of each model is shown in the table below. The up-arrow value represents the performance improvement compared to each corresponding ImageNet pre-trained model. As a common practice, we utilized MGN and TransReID as the fine-tuning algorithms. Please refer to [our paper](https://arxiv.org/abs/2409.18569) for more experimental details and results. 
